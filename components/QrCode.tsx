...
/**
 * The white plate and the four-module margin around the code are not styling.
 * Scanners look for a quiet zone to find the code's edges, and they expect dark
 * modules on light — inverted or flush to the edge, plenty of phones simply
 * never lock on. So this stays light even though everything around it is dark.
 */
const QUIET = 4;
...
export default function QrCode({
  ...
  const { path, span } = useMemo(() => {
    ...
    const modules = encodeQR(text.toUpperCase(), "raw") as boolean[][];
